...
\chap{EXPERIENCE}{
    ...
    \job
        ...
        \begin{newitemize}
            ...
            \item Contributed to AKS HPA scaling and resolved OOMKills, improving memory utilization and system reliability.
            ...
            \item Enhanced Spring Boot microservices and optimized SQL queries, increasing deployment efficiency and reducing bottlenecks.
    ...
    \job
        ...
        \begin{newitemize}
            ...
            \item Received Employee of the Quarter and Month awards for leadership and impactful process improvements.
            \item Promoted from Software Engineer in 2022 for consistent delivery and technical leadership.
        \end{newitemize}
        }
...
\chap{SKILLS}{
    {\begin{newitemize}
        ...
        \item {\fontspec[Path = fonts/]{Times-New-Roman-Bold}\textbf{Frameworks \& Libraries:}} Spring Boot, Hibernate, React, Flask, jQuery, Selenium, JUnit
        \item {\fontspec[Path = fonts/]{Times-New-Roman-Bold}\textbf{Cloud \& DevOps:}} Microsoft Azure, Docker, Jenkins, Terraform (IaC), NGINX
        \item {\fontspec[Path = fonts/]{Times-New-Roman-Bold}\textbf{Databases:}} MongoDB, PostgreSQL, MySQL, SQL Server, Oracle PL/SQL
        \item {\fontspec[Path = fonts/]{Times-New-Roman-Bold}\textbf{Tools \& Platforms:}} Git, Maven, Bash, Linux, Apache Kafka, WebSocket, JIRA
        \item {\fontspec[Path = fonts/]{Times-New-Roman-Bold}\textbf{Web Technologies:}} HTML, CSS, XML, JSON, YAML, REST APIs
    \end{newitemize}
    }
}
